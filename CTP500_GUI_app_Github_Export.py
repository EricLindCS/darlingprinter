...
mac_address = "03:4f:3b:05:83:df" #Put in your printer's Bluetooth device address here - you can find it in the app
...
def create_text(text, font_name="Lucon.ttf", font_size=28):
    ...
    # If just a filename, try to find it in Windows Fonts directory
    ...
    try:
        font = PIL.ImageFont.truetype(font_path, font_size) #Loads up font_name as the default font, at font_size default size
    except OSError:
